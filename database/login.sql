...
--
-- Host: 127.0.0.1    Database: sistemagestionusuarios
-- ------------------------------------------------------
...
CREATE TABLE `permisos` (
  ...
  CONSTRAINT `permisos_ibfk_2` FOREIGN KEY (`id_sistema`) REFERENCES `sistemas` (`id_sistema`) ON DELETE CASCADE
...
CREATE TABLE `tokens` (
  ...
  CONSTRAINT `tokens_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-07 20:56:11
